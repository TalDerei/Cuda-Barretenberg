...
namespace internal {
    ...
    __device__ __forceinline__
    void addc_cc(u32 &s, u32 a, u32 b) {
    ...
    __device__ __forceinline__
    void addc_cc(u64 &s, u64 a, u64 b) {
     ...
     */
    __device__ __forceinline__
    void mul_hi(u32 &hi, u32 a, u32 b) {
    ...
    __device__ __forceinline__
    void mul_hi(u64 &hi, u64 a, u64 b) {
     ...
     */
    __device__ __forceinline__
    void mad_wide(u32 &hi, u32 &lo, u32 a, u32 b, u32 c) {
        asm ("{\n\t"
             " .reg .u64 tmp;\n\t"
    ...
    __device__ __forceinline__
    void mad_wide(u64 &hi, u64 &lo, u64 a, u64 b, u64 c) {
    ...
    __device__ __forceinline__
    void madc_lo_cc(u32 &lo, u32 a, u32 b, u32 c) {
    ...
    __device__ __forceinline__
    void madc_lo_cc(u64 &lo, u64 a, u64 b, u64 c) {
    ...
    __device__ __forceinline__
    void madc_hi_cc(u32 &hi, u32 a, u32 b, u32 c) {
    ...
    __device__ __forceinline__
    void madc_hi_cc(u64 &hi, u64 a, u64 b, u64 c) {
    ...
    __device__ __forceinline__
    void min(u32 &m, u32 a, u32 b) {
        asm ("min.u32 %0, %1, %2;" : "=r"(m) : "r"(a), "r"(b));
    }

    __device__ __forceinline__
    void min(u64 &m, u64 a, u64 b) {
        asm ("min.u64 %0, %1, %2;" : "=l"(m) : "l"(a), "l"(b));
    }

    __device__ __forceinline__
    void max(u32 &m, u32 a, u32 b) {
        asm ("max.u32 %0, %1, %2;" : "=r"(m) : "r"(a), "r"(b));
    }

    __device__ __forceinline__
    void max(u64 &m, u64 a, u64 b) {
