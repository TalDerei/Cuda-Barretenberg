...
class group_gpu {
    public:    
        ...
        __device__ __forceinline__ static void add(var X1, var Y1, var Z1, var X2, var Y2, var Z2, var &res_x, var &res_y, var &res_z);

        __device__ __forceinline__ static void mixed_add(var X1, var Y1, var Z1, var X2, var Y2, var &res_x, var &res_y, var &res_z);

        __device__ __forceinline__ static void doubling(var X, var Y, var Z, var &res_x, var &res_y, var &res_z);
        ...
        __device__ __forceinline__ static void add_projective(var X1, var Y1, var Z1, var X2, var Y2, var Z2, var &res_x, var &res_y, var &res_z);
};
