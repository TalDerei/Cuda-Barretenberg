...
// // Define sample curve in fields constructor 
// TEST(fq, eq)
// {
//     // Lenght 4 array of uint64_t ints
...
// // Checking if elements equal zero
// TEST(fq, is_zero)
// {
//     // returns field(0, 0, 0, 0)
//     fq a = fq::zero();
//     fq b = fq::zero();
//     fq c = fq::zero();
//     fq d = fq::zero();
...
// // Checking if random elements collid or are the zero element
...
//     constexpr fq b{ 0x7d2e20e82f73d3e8, 0x8e50616a7a9d419d, 0xcdc833531508914b, 0xd510253a2ce62c };

//     constexpr fq expected{ 0xbf4fb34e120b8b12, 0xf64d70efbf848328, 0xefbb6a533f2e7d89, 0x1de50f941425e4aa };
//     constexpr fq a_ex = a.sqr();
//     constexpr fq b_ex = b.sqr();

//     constexpr fq result = a_ex - b_ex;

//     printf("a_ex.data[0] is: %zu\n", a_ex.data[0]);
//     printf("a_ex.data[1] is: %zu\n", a_ex.data[1]);
//     printf("a_ex.data[2] is: %zu\n", a_ex.data[2]);
//     printf("a_ex.data[3] is: %zu\n", a_ex.data[3]);

//     printf("b_ex.data[0] is: %zu\n", b_ex.data[0]);
//     printf("b_ex.data[1] is: %zu\n", b_ex.data[1]);
//     printf("b_ex.data[2] is: %zu\n", b_ex.data[2]);
//     printf("b_ex.data[3] is: %zu\n", b_ex.data[3]);

//     printf("result.data[0] is: %zu\n", result.data[0]);
//     printf("result.data[1] is: %zu\n", result.data[1]);
//     printf("result.data[2] is: %zu\n", result.data[2]);
//     printf("result.data[3] is: %zu\n", result.data[3]);
