...
void generate_test_plonk_circuit(waffle::TurboComposer& composer, size_t num_gates)
{
...
waffle::TurboProver provers[NUM_CIRCUITS];
waffle::TurboVerifier verifiers[NUM_CIRCUITS];
